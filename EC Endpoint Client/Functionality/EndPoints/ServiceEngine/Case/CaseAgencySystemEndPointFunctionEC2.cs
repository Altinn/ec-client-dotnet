...
{
    class CaseAgencySystemEndPointFunctionEC2 : EndPointFunctionalityBase
    {
        private CaseAgencySystemEC2Client GenerateProxy(BaseShipment shipment)
        {
            return base.GenerateProxy<CaseAgencySystemEC2Client, ICaseAgencySystemEC2>(shipment.EndpointName,
        ...
        public void SetNotice(SetNoticeShipmentEC2 shipment)
        {
            var client = GenerateProxy(shipment);
