...
{
    class BrokerServiceStreamedEndPointFunctionEC2 : EndPointFunctionalityBase
    {
        private BrokerServiceExternalEC2StreamedClient GenerateProxy(BaseShipment shipment, bool setInspectorBehavior = true)
        {
            return
                base.GenerateProxy<BrokerServiceExternalEC2StreamedClient, IBrokerServiceExternalEC2Streamed>(
