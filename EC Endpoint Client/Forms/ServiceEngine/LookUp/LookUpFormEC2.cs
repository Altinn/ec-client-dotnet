...
{
    public partial class LookUpFormEC2 : BaseForms.ClientBaseForm
    {
        private LookUpEndPointFunctionEC2 _lookUpEndPointFunction;

        public LookUpShipmentEC2 LookUpShipment;
        ...
        {
            LookUpShipment = Functionality.IoFunctionality.GeneralizedLoadFile(LookUpShipment);
