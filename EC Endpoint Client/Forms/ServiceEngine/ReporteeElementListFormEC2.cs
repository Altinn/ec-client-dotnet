...
{
    public partial class ReporteeElementListFormEC2 : AgencyBaseForm
    {
        private Functionality.EndPoints.ServiceEngine.ReporteeElementListEndPointFunctionEC2 _relepFunc;
        public DeleteReporteeElementShipmentEC2 ShipmentDeleteRe { get; set; }
        public ReporteeElemenetListShipmentBaseEC2 ShipmentGetCorrForAr { get; set; }
        public ReporteeElemenetListShipmentBaseEC2 ShipmentGcfr { get; set; }
        public GetFormSetShipmentBaseEC2 ShipmentGetFormSet { get; set; }
        ...
        public GetReporteeElementListShipmentEC2 ShipmentGrel { get; set; }
        ...
        public ReporteeElementListFormEC2()
        {
            InitializeComponent();
            _relepFunc = new Functionality.EndPoints.ServiceEngine.ReporteeElementListEndPointFunctionEC2();
            _relepFunc.ReturnMessageXml += ReturnMessageXmlHandler;
            ShipmentDeleteRe = new DeleteReporteeElementShipmentEC2();
            ShipmentGetCorrForAr = new ReporteeElemenetListShipmentBaseEC2();
            ShipmentGetFormSet = new GetFormSetShipmentBaseEC2();
            ...
            ShipmentGcfr = new ReporteeElemenetListShipmentBaseEC2();
            ShipmentGrel = new GetReporteeElementListShipmentEC2();
        ...
        private void LoadShipmentByTabPage()
        {
            ...
            {
                case "DeleteRE":
                    ShipmentDeleteRe = Functionality.IoFunctionality.GeneralizedLoadFile(ShipmentDeleteRe);
                    break;
                case "GetCorrListForArch":
                    ShipmentGetCorrForAr = Functionality.IoFunctionality.GeneralizedLoadFile(ShipmentGetCorrForAr);
                    break;
                case "GetCorrListForRep":
                    ShipmentGcfr = Functionality.IoFunctionality.GeneralizedLoadFile(ShipmentGcfr);
                    break;
                case "GetFS":
                    ShipmentGetFormSet = Functionality.IoFunctionality.GeneralizedLoadFile(ShipmentGetFormSet);
                    break;
                case "GetRE":
                    ShipmentGrel = Functionality.IoFunctionality.GeneralizedLoadFile(ShipmentGrel);
                    break;
            }
        }
