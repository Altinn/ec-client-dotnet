...
{
    public partial class CaseAgencyFormEC2 : AgencyBaseForm
    {
        private CaseAgencySystemEndPointFunctionEC2 FuncCasep { get; set; }
        ...
        public NotifyEventShipmentEC2 ShipmentNotifyEvent { get; set; }
        ...
        public SetNoticeShipmentEC2 ShipmentSetNotice { get; set; }
        ...
        {
            ShipmentSetNotice = Functionality.IoFunctionality.GeneralizedLoadFile(ShipmentSetNotice);
        }
