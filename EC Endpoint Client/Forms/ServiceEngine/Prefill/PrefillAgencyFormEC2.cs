...
{
    public partial class PrefillAgencyFormEC2 : AgencyBaseForm
    {
        private PrefillAgencyEndPointFunctionEC2 _paepFunc;
        public SubmitPrefillFormTaskShipmentEC2 ShipmentSpf { get; set; }
        public SubmitAndInstantiatePrefillFormTaskShipmentEC2 ShipmentSaipf { get; set; }
        ...
        {
            ShipmentSpf = Functionality.IoFunctionality.GeneralizedLoadFile(ShipmentSpf);
            SetViewedItem(ShipmentSpf, "Shipment for SubmitPrefilledFormTasks");
        }
        ...
        {
            ShipmentSaipf = Functionality.IoFunctionality.GeneralizedLoadFile(ShipmentSaipf);
            SetViewedItem(ShipmentSaipf, "Shipment for SubmitAndInstantiatePrefilledFormTask");
        }
