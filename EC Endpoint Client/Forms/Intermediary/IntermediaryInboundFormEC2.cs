...
{
    public partial class IntermediaryInboundFormEC2 : BaseForms.ClientBaseForm
    {
        private Functionality.EndPoints.Intermediary.IntermediaryInboundEndPointFunctionalityEC2 IiepFunc { get; set; }

        public IntermediaryInboundShipmentEC2 IiShipment { get; set; }

        public IntermediarySignShipmentEC2 SignShipment { get; set; }
        ...
        public UpdateFormDataInputEC2 FormTaskUpdate { get; set; }
        ...
        public IntermediaryInboundFormEC2()
        {
            ...
            {
                FormTaskUpdate = new FormTaskUpdate {FormUpdateList = new FormUpdateList()}
            };
